      ...
      <body className={'min-h-screen flex flex-col text-slate-700 ' + poppins.className}>
        <header className='flex p-4 sm:p-5 border-b'>
          <div className='flex font-medium text-xs sm:text-sm items-center max-w-[900px] mx-auto w-full'>
            <Link href={'/'} className='hidden sm:inline'>Jorge Valles</Link>
         
            <Link href={'/'} className='sm:hidden'>JV</Link>
          </div>
        ...
        <footer className='flex p-4 py-16 text-xs text-slate-600 sm:text-sm border-t items-center justify-center flex-col gap-6'>
          <div className='flex items-center justify-center gap-4'>
            <a  download href="/CV.pdf" className='cursor-pointer hover:opacity-60 duration-200'>PDF Resume</a >
            <p>|</p>
          ...
          <div className='flex items-center justify-center gap-4 text-lg sm:text-xl'>
            <a className='cursor-pointer hover:opacity-60 duration-200'  href={'https://www.linkedin.com/in/jorgeluisvalles/'} target="_blank">
              <i className="fa-brands fa-linkedin-in"></i>
            </a>
            <a className='cursor-pointer hover:opacity-60 duration-200' href={'https://github.com/jorgevalles'} target="_blank">
              <i className="fa-brands fa-github"></i>
            </a>
            <a className='cursor-pointer hover:opacity-60 duration-200' href={'mailto:1jorgevalles@gmail.com'}  target="_blank">
            <i class="fa-solid fa-envelope"></i>
            </a>
            <a className='cursor-pointer hover:opacity-60 duration-200' href={'//wa.me/+573232373531'}  target="_blank">
