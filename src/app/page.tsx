...
const links = [
  {name: 'Email', link: 'mailto:1jorgevalles@gmail.com',content:'1jorgevalles@gmail.com'},
  {name: 'GitHub', link: 'https://github.com/jorgevalles',content:'jorgevalles'},
  {name: 'LinkedIn', link: 'https://www.linkedin.com/in/jorgeluisvalles/',content:'jorgeluisvalles'}
]

const skills = [
  
  {name: 'Wed', content: ['API Rest','WebPack','Babel','Bootstrap','Google Analitics','Google Tag Manager', 'Tailwind','CSS', 'Sass', 'AWS', 'GIT','GitHub','Material UI', 'Docker']},
  {name: 'Design', content: ['SSR','SSG','ISR','SEO on Page','Responsitive','Atomic','Thinking','Canvas', 'pixlr', 'figma']},
...
const workHistory =[
{name: 'Trainig Escalab Academy', content: 'Desarrollador de Aplicaciones en React. y Node.' }
]

const hobbies = [
{name: 'Making coding app', content:'I really enjoy programing'},
{name: 'Practice sports', content:'I love playing sports with my children'},
{name: 'Travel to the beach', content:'I really enjoy being on the beach and sailing.'}
]
const now = new Date();
...
return (
  <main className='flex flex-col gap-5 p-4 mx-auto max-w-[900px] w-full'>
    <h3 className ='text-end ' suppressHydrationWarning>  {format(dataTime, "h:mm:ss b EEEE d 'de' MMMM yyyy", { 
})} </h3>
    ...
    <section>
      ...
      <p className='text-xs sm:text-sm' >Check out my latest <Link href={'/certificates'} className='text-sky-400' >Certificates</Link></p>
